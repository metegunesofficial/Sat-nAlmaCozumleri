    ...
    <div className="h-screen w-64 bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-700 flex flex-col">
      ...
      <div className="h-16 flex items-center px-6 border-b border-gray-200 dark:border-gray-700">
        <Link href="/dashboard" className="flex items-center gap-2">
          ...
          <span className="font-bold text-lg text-gray-800 dark:text-white">Attelia</span>
        </Link>
      </div>
      ...
      <div className="p-4 border-t border-gray-200 dark:border-gray-700 space-y-2">
        <button
          ...
          className="w-full flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors"
        >
